...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">프로필</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{stats.thisMonthDiaries}</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">평균 원본 단어</p>
              <p className="text-2xl font-bold text-purple-600">{stats.averageWordsOriginal}</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">평균 AI 단어</p>
              <p className="text-2xl font-bold text-pink-600">{stats.averageWordsEnhanced}</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-3">
            {diaries.slice(0, 5).map((diary) => (
              <div key={diary.id} className="border-l-4 border-green-600 pl-4">
                <h3 className="font-medium text-gray-800 truncate">{diary.title}</h3>
                <p className="text-sm text-gray-600 truncate">{diary.original_content}</p>
            ...
            {diaries.length === 0 && (
              <p className="text-gray-500 text-center py-8">아직 작성된 일기가 없습니다.</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 bg-white rounded-xl p-6 shadow-lg">
        <h2 className="text-xl font-semibold mb-4">일기 작성 팁</h2>
        <div className="grid md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium mb-2">꾸준히 작성하기</h4>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium mb-2">감정도 함께 적기</h4>
              <p className="text-sm text-gray-600">
